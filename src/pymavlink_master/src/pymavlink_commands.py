...
class Basic:
    ...
    def __init__(self) -> None:  
        ...
        self.thruster_subs = rospy.Subscriber("/master/commands", commands, self.__callback__, queue_size=1)
...
if __name__ == "__main__":
    ...
    parser.add_option("-p", "--port", dest="port_addr",default="/dev/Pixhawk",help="Pass Pixhawk Port Address", metavar="VAR")
